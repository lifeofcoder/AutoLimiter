 ...
 */
package com.lifeofcoder.autolimiter.cluster.common.registry;
...
public final class ConfigSupplierRegistry {
    private static Logger LOGGER = LoggerFactory.getLogger(ConfigSupplierRegistry.class);
    ...
    public static void setNamespaceSupplier(Supplier<String> namespaceSupplier) {
        ...
        LOGGER.info("[ConfigSupplierRegistry] New namespace supplier provided, current supplied: " + namespaceSupplier.get());
    }
