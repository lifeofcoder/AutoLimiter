...
public class ModifyClusterParamFlowRulesCommandHandler implements CommandHandler<String> {
    private static Logger LOGGER = LoggerFactory.getLogger(ModifyClusterParamFlowRulesCommandHandler.class);
    ...
    public CommandResponse<String> handle(CommandRequest request) {
        ...
        try {
            ...
            LOGGER.info("Receiving cluster param rules for namespace <{}> from command handler: {}", namespace, data);
            ...
            LOGGER.warn("[ModifyClusterParamFlowRulesCommandHandler] Decode cluster param rules error", e);
