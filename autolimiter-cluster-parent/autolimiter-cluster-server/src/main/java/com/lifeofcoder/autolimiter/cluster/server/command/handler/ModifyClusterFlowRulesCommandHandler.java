...
public class ModifyClusterFlowRulesCommandHandler implements CommandHandler<String> {
    private static Logger LOGGER = LoggerFactory.getLogger(ModifyClusterFlowRulesCommandHandler.class);
    ...
    public CommandResponse<String> handle(CommandRequest request) {
        ...
        try {
            ...
            LOGGER.info("[ModifyClusterFlowRulesCommandHandler] Receiving cluster flow rules for namespace <{}>: {}", namespace, data);
            ...
            LOGGER.warn("[ModifyClusterFlowRulesCommandHandler] Decode cluster flow rules error", e);
