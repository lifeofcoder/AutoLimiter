...
public final class ConnectionManager {
    ...
    public static void removeConnection(String address) {
        ...
        if (namespace != null) {
            ...
            LOGGER.info("[ConnectionManager] Client <{}> disconnected and removed from namespace <{}>", address, namespace);
        }
    ...
    public static ConnectionGroup addConnection(String namespace, String address) {
        ...
        LOGGER.info("[ConnectionManager] Client <{}> registered with namespace <{}>", address, namespace);
        return group;
    }
