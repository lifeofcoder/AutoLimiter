...
final class ClusterFlowChecker {
    private static Logger LOGGER = LoggerFactory.getLogger(ClusterFlowChecker.class);
    ...
    static TokenResult acquireClusterToken(/*@Valid*/ FlowRule rule, int acquireCount, boolean prioritized) {
        ...
        ClusterMetric metric = ClusterMetricStatistics.getMetricAndRecordHistory(id);
        if (metric == null) {
