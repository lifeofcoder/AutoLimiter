...
public class NettyResponseDecoder extends ByteToMessageDecoder {
    private static Logger LOGGER = LoggerFactory.getLogger(NettyResponseDecoder.class);
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        if (responseDecoder == null) {
            LOGGER.warn("[NettyResponseDecoder] Cannot resolve the global response entity decoder, " + "dropping the response");
            return;
        }
