...
public class ClusterClientStartUpConfig {
    private static Logger LOGGER = LoggerFactory.getLogger(ClusterClientStartUpConfig.class);
    ...
    public static Integer getMaxParamByteSize() {
        ...
        try {
            ...
            LOGGER.warn("[ClusterClientStartUpConfig] Failed to parse maxParamByteSize: " + maxParamByteSize);
            return null;
        }
    }
