...
import com.lifeofcoder.autolimiter.dashboard.ignite.dao.impl.IgniteAuthDao;
...
public class Ignite4AuthorityTest {

    public static void main(String[] args) {
        new Ignite4AuthorityTest().client();
    }
    ...
    private void getAuthority(Ignite ignite) {
        System.out.println("==========metrics=============");
        IgniteCache<Object, Object> cache = ignite.getOrCreateCache(IgniteAuthDao.CACHE_NAME);
        Object o = cache.get("");
        IgniteAuth igniteAuth = (IgniteAuth) o;
        System.out.println(igniteAuth.getLoginName());
