 ...
 */
package com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.domain.cluster;
...
public class ClusterClientInfoVO {
    ...
    public String toString() {
        return "ClusterClientInfoVO{" + "serverHost='" + serverHost + '\'' + ", serverPort=" + serverPort + ", clientState=" + clientState + ", requestTimeout=" + requestTimeout + '}';
    }
}
