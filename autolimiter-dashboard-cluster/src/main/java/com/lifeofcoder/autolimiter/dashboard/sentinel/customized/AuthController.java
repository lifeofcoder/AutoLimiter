...
/**
 * 自定义AuthController，需要注释调用默认的：AuthController
 */
@RestController
@RequestMapping("/auth")
public class AuthController {
    ...
    @Autowired
    private IgniteAuthService authService;

    @PostMapping("/login")
    public Result<AuthService.AuthUser> login(HttpServletResponse response, HttpServletRequest request, String username, String password) {
        ...
        return Result.ofSuccess(authService.addAuthUser(username, request, response));
    }
