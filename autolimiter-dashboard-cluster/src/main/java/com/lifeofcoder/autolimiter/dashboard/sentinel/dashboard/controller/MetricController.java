...
import com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.domain.vo.MetricVo;
...
public class MetricController {
    ...
    public Result<?> queryTopResourceMetric(final String app, Integer pageIndex, Integer pageSize, Boolean desc, Long startTime, Long endTime, String searchKey) {
