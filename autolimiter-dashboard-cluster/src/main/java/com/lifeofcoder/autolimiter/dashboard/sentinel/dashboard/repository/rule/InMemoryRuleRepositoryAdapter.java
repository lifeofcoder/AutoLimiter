 ...
 */
package com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.repository.rule;
...
public abstract class InMemoryRuleRepositoryAdapter<T extends RuleEntity> implements RuleRepository<T, Long> {
    ...
    public T save(T entity) {
        ...
        if (processedEntity != null) {
            ...
            machineRules.computeIfAbsent(MachineInfo.of(processedEntity.getApp(), processedEntity.getIp(), processedEntity.getPort()), e -> new ConcurrentHashMap<>(32)).put(processedEntity.getId(), processedEntity);
