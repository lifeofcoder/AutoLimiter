 ...
 */
package com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.domain.cluster.request;
...
public class ClusterServerModifyRequest implements ClusterModifyRequest {
    ...
    public String toString() {
        return "ClusterServerModifyRequest{" + "app='" + app + '\'' + ", ip='" + ip + '\'' + ", port=" + port + ", mode=" + mode + ", flowConfig=" + flowConfig + ", transportConfig=" + transportConfig + ", namespaceSet=" + namespaceSet + '}';
    }
}
