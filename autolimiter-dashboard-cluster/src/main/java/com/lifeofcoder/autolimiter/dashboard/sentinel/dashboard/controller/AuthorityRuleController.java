...
import com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.datasource.entity.rule.AuthorityRuleEntity;
...
public class AuthorityRuleController {
    ...
    private <R> Result<R> checkEntityInternal(AuthorityRuleEntity entity) {
        ...
        if (entity.getStrategy() != RuleConstant.AUTHORITY_WHITE && entity.getStrategy() != RuleConstant.AUTHORITY_BLACK) {
