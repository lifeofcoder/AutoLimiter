 ...
 */
package com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.repository.metric;
...
public class InMemoryMetricsRepository implements MetricsRepository<MetricEntity> {
    ...
    public synchronized void save(MetricEntity entity) {
        ...
        allMetrics.computeIfAbsent(entity.getApp(), e -> new ConcurrentHashMap<>(16))
                .computeIfAbsent(entity.getResource(), e -> new ConcurrentLinkedHashMap.Builder<Long, MetricEntity>().maximumWeightedCapacity(MAX_METRIC_LIVE_TIME_MS).weigher((key, value) -> {
