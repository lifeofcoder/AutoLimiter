...
import com.lifeofcoder.autolimiter.dashboard.sentinel.dashboard.domain.vo.MachineInfoVo;
...
public class AppController {
    ...
    public Result<String> removeMachineById(@PathVariable("app") String app, @RequestParam(name = "ip") String ip, @RequestParam(name = "port") int port) {
        AppInfo appInfo = appManagement.getDetailApp(app);
        if (appInfo == null) {
            return Result.ofSuccess(null);
        }
